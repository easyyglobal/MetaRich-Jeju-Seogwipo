...
// ... (rest of the file remains same, just need to update the component logic)
  ...
  },
  {
    ...
    title: '보상 권리 세이프가드',
    desc: '보험은 가입보다 보상이 중요합니다. 전문가가 고객의 파트너로서 보상 과정을 정밀 체킹하여 정당한 권리를 끝까지 지켜드립니다.',
    details: [
      '청구 서류 안내 및 검토',
      '보험사별 청구 프로세스 대행',
      '누락된 미지급 보상금 역추적 및 재진단',
      '분쟁 발생 시 전문가 자문 지원'
    ]
  }
];
...
const specialProjects = [
  ...
  },
  {
    id: 'local',
    title: '제주 특화 상품 안내',
    content: '제주도민의 생활 특성을 고려한 특화 담보 및 지역 밀착형 상품 정보를 신속하게 안내해 드립니다.'
  }
];
