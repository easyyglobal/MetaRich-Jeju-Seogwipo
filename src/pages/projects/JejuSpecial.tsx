    ...
    <div>
      <section className="relative h-[50vh] md:h-[60vh] flex items-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center text-white">
          ...
          >
            <h1 className="text-3xl md:text-6xl font-bold mb-6">제주 특화 사업 안내</h1>
            <p className="md:text-xl text-slate-200 max-w-3xl mx-auto md:leading-relaxed">
      ...
      <section className="py-16 md:py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 md:gap-12">
            {[
              {
                icon: <Palmtree className="text-emerald-500" size={38} />,
                title: "농/어업 리스크 관리",
                desc: "제주의 주요 산업인 농업과 어업 종사자분들을 위한 특화 재해 보험 및 리스크 관리 솔루션을 제공합니다.",
                image: "/images/jeju-farming.jpg"
              },
              {
                icon: <Anchor className="text-blue-500" size={38} />,
                title: "제주 특화 담보 안내",
              ...
              >
                ...
                <div className="p-6 md:p-10">
                  ...
                  <p className="text-slate-600 md:leading-relaxed mb-4 md:mb-8">{item.desc}</p>
      ...
      <section className="py-16 md:py-24 bg-emerald-50">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <Map className="text-emerald-600 mx-auto mb-8" size={45} />
          <h2 className="text-2xl md:text-3xl font-bold mb-6">제주도민을 위한 가장 가까운 파트너</h2>
          <p className="text-slate-600 md:text-lg mb-10">
